        ...
        if (isset($_POST['generate_pdf'])) {
            ...
            try {
                ...
                if ($stmt1->rowCount() > 0 && $stmt2->rowCount() > 0) {
                    ...
                    $pdf = new MonPDF($nom, $prenom, $adr, $tel, $date_n, $email, 'weekend', $date_visite, $tot, $quantite_adulte, $quantite_enfant);
                    $pdf->AddPage();
...
?>
        ...
        if($_SERVER["REQUEST_METHOD"]=='POST'){
            ...
            $sql3="SELECT id_tarif FROM tarif2 WHERE descr='Billet weekend'";
